...
public class VegetableControllerWithEscapedAndFallen : VegetableBaseController, IVegetableControllerWithBadAndGoodScenarios
{
    ...
    protected override IEnumerator Mover()
    {
        ...
        yield return transform.DOMove(_localConfig.Shelfs[_model.ShelfIndex].EndPosition.position, _gameConfig.CatchDelay).SetEase(Ease.Linear).WaitForCompletion();
